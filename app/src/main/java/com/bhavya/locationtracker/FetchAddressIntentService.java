...
public class FetchAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            errorMessage = "Invalid Lat Long";//getString(R.string.invalid_lat_long_used);
        ...
        if (addresses == null || addresses.size()  == 0) {
            if (errorMessage.isEmpty()) {
                errorMessage = "No Address Found";//getString(R.string.no_address_found);
                Log.e(TAG, errorMessage);
            }
            ...
            Log.i(TAG, " Address Found"/*getString(R.string.address_found)*/);
